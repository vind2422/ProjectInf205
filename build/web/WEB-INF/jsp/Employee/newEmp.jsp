                                    ...
                                    <div class="card card-profile">
                                            ...
                                            <a href="">
                                                ...
                                                <c:choose>          
                                                    <c:when test="${src.equals('') && emp.photo.equals('') }">
                                                        <img src="${root}/images/images.jpg" class="img" />
                                                    </c:when>
                                        ...
                                        <div class="content">
                                            ...
                                            <div>
                                                ...
                                                <input type="file" id="file" name="photo3" style="visibility:hidden;">
                                                <button id="img1" style="visibility:hidden;" name="btnUpHinh2"></button>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <form>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input name="birthday" value="${DATE}" class="form-control" id="datepicker" > 
                                                ...
                                                <button name="btnInsert" class="btn btn-primary pull-right">Insert</button>
