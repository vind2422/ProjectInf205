    ...
    <script>
        $(function () {
            $("a[data-lang]").click(function () {
                ...
                $.get("dataDepart.htm?language=" + lang, function () {
                    location.reload();
                });
                return false;
            });
        ...
        $(function () {
            $("a[data-lang]").click(function () {
                var lang = $(this).attr("data-lang");
                $.get("dataDetailsDepart.htm?language=" + lang, function () {
                    location.reload();
                });
                return false;
            });
        ...
        $(function () {
            $("a[data-lang]").click(function () {
                var lang = $(this).attr("data-lang");
                $.get("editDepart.htm?language=" + lang, function () {
                    location.reload();
                });
                return false;
            });
        ...
        $(function () {
            $("a[data-lang]").click(function () {
                var lang = $(this).attr("data-lang");
                $.get("newDepart.htm?language=" + lang, function () {
                    location.reload();
                });
                return false;
            });
